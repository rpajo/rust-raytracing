...
fn main() -> std::io::Result<()> {
    ...
    let render_image_height = (render_image_width as f64 / image_aspect_ratio) as i32;

    let viewport_height = 2.0;
    let image_ratio = render_image_width as f64 / render_image_height as f64;
    ...
    let pixel_delta_u = vp_u_dir / render_image_width as f64;
    let pixel_delta_v = vp_v_dir / render_image_height as f64;
    ...
    for y in 0..render_image_height {
        ...
        for x in 0..render_image_width {
            let pixel_pos = pixel_00_loc + y as f64 * pixel_delta_v + x as f64 * pixel_delta_u;
